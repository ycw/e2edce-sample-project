...
function init() {
	...
	water = new Water(
		waterGeometry,
		{
			textureWidth: 512,
			textureHeight: 512,
			waterNormals: new TextureLoader().load('https://rawcdn.githack.com/mrdoob/three.js/r141/examples/textures/waternormals.jpg', function (texture) {
	...
	function updateSun() {
		...
		const phi = degToRad(90 - parameters.elevation);
		const theta = degToRad(parameters.azimuth);
